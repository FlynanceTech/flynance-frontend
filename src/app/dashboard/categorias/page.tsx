        ...
        <TabList className="flex items-center gap-2 mb-4">
          <Tab className={({ selected }) =>
            clsx(
              ...
              selected ? 'bg-secondary/30 text-primary rounded-full' : 'bg-gray-100 text-gray-600'
            )
          }>
            Despesas
          </Tab>
          <Tab className={({ selected }) =>
            clsx(
              'px-4 py-2 text-sm font-medium outline-none cursor-pointer',
              selected ? 'bg-secondary/30 text-primary rounded-full' : 'text-gray-500 hover:text-black'
            )
          }>
            Receitas
          </Tab>
