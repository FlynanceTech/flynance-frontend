  ...
  return (
    <form onSubmit={handleSubmit(internalSubmit)} className="flex flex-col gap-4 bg-white rounded-md border border-gray-200 p-6 sm:p-8">
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:gap-4 items-end">
        ...
        <div className="w-full flex flex-col items-start">
          ...
          <div className={clsx(
            ...
            <button
              ...
              className="h-12 min-w-12 flex items-center justify-center bg-secondary text-white rounded-full hover:bg-secondary/35text-sm cursor-pointer"
            >
              <Plus />
            </button>
          </div>
        ...
        <button type="submit" className="h-12 flex items-center justify-center gap-2 bg-secondary rounded-full text-white px-4 py-2 hover:bg-bg-secondary/35w-full cursor-pointer lg:w-auto">
          {editing ? <Check /> : <Plus />}
