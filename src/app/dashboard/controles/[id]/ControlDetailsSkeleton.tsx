...
export default function ControlDetailsSkeleton() {
  return (
    <div className="flex h-full w-full flex-col overflow-auto pb-16 lg:pr-8 lg:pb-0">
      <div className="flex flex-col gap-4 rounded-b-3xl rounded-t-none bg-white p-8 text-gray-600 lg:rounded-2xl dark:bg-slate-900 dark:text-slate-200">
        ...
        <div className="grid grid-cols-2 rounded-b-2xl rounded-md bg-white p-4 text-gray-500 ring-1 ring-slate-200/80 lg:p-0 dark:bg-slate-800 dark:ring-slate-700/80">
          <div className="flex flex-col items-center justify-center gap-3 border-r border-gray-200 py-4 dark:border-slate-700">
            <div className="h-6 w-20 animate-pulse rounded bg-slate-100 dark:bg-slate-700" />
            <div className="h-10 w-28 animate-pulse rounded bg-slate-200 dark:bg-slate-700" />
          </div>
          <div className="flex flex-col items-center justify-center gap-3 py-4">
            <div className="h-6 w-28 animate-pulse rounded bg-slate-100 dark:bg-slate-700" />
            <div className="h-10 w-28 animate-pulse rounded bg-slate-200 dark:bg-slate-700" />
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-4 p-8 pt-4">
        <div className="rounded-xl border border-slate-200/80 bg-white p-4 dark:border-slate-800 dark:bg-slate-900">
          <div className="mb-4 h-[300px] animate-pulse rounded bg-slate-100 dark:bg-slate-800" />
          <div className="mx-auto h-4 w-72 animate-pulse rounded bg-slate-100 dark:bg-slate-800" />
        </div>
        ...
        <div className="space-y-4">
          {Array.from({ length: 3 }).map((_, index) => (
            <div key={index} className="rounded-md border border-slate-200/80 bg-white p-4 dark:border-slate-800 dark:bg-slate-900">
              <div className="flex items-center justify-between">
              ...
              <div className="mt-3 h-4 w-20 animate-pulse rounded bg-slate-100 dark:bg-slate-800" />
            </div>
          ))}
        </div>
      </div>
