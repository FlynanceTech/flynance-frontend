...
export default function StickyBar() {
  ...
  return (
    <>
      <div className="fixed bottom-0 w-full bg-linear-to-r from-secondary to-[#3B82F6] px-6 py-3 flex justify-center items-center z-40">
        <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 justify-between items-center">
          ...
          <Link
            ...
            className="bg-secondary w-full md:max-w-44 text-white text-center text-sm font-medium px-5 py-3 rounded-md hover:bg-[#13A897] transition cursor-pointer">
            Inscrever-se
          </Link>
        </div>
      </div>
