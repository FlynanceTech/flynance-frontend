...
export const APP_MESSAGES: Record<AppLocale, any> = {
  'pt-BR': {
    ...
    transactions: {
      ...
      invalidCsvFile: 'Arquivo inválido. Envie um arquivo .csv ou .pdf.',
      previewTable: {
        date: 'Data',
      ...
      doubleClickToEdit: 'Duplo clique para editar a descrição',
      suggestedCategoryBy: 'Categoria sugerida por: {keyword}',
      selectCategory: 'Selecionar categoria',
      removeFromPreview: 'Remover da importação',
      previewDialog: {
        title: 'Prévia de transações a importar',
        aiApplied: 'IA aplicada',
        subtitle: 'Revise, categorize ou renomeie as transações antes de finalizar.',
        noneFound: 'Nenhuma transação encontrada',
        newCount: '{count} transações',
        newCountSince: '{count} transações desde {date}',
        importing: 'Importando...',
        confirmImport: 'Confirmar Importação',
        tip: 'Dica: duplo clique na descrição para editar. Use o seletor de categoria para ajustar.',
        cardDetected: 'Cartão detectado: {cardName}',
        cardNotDetected: 'Não foi possível identificar o cartão automaticamente.',
        selectCard: 'Selecionar cartão',
        noCardsRegistered: 'Nenhum cartão cadastrado.',
        uncategorizedTitle: 'Gastos não identificados',
        uncategorizedSubtitle: 'Não consegui identificar a categoria dos gastos abaixo. Como deseja categorizá-los?',
        proceedAnyway: 'Prosseguir assim mesmo',
        installmentBadge: 'Parcelado',
      },
      bulkRename: {
        title: 'Renomear descrições iguais?',
        description:
          'Há {count} transações para esse mesmo estabelecimento. Deseja renomear todas para "{value}"?',
        cancel: 'Cancelar',
      ...
      bulkCategory: {
        ...
        description:
          'Há {count} transações com a descrição "{description}". Deseja aplicar a categoria selecionada para todas?',
        cancel: 'Cancelar',
        confirm: 'Aplicar a todas',
      },
      onboarding: {
    ...
    coupleInvitePage: {
      title: 'E aí, vamos atualizar o orçamento juntos?',
      subtitle: 'Oi! Você foi convidado(a) para participar da conta de casal de {ownerName} na Flynance.',
      subtitleFallback: 'Oi! Você foi convidado(a) para participar de uma conta de casal na Flynance.',
      fallbackOwner: 'o titular',
      whatChangesTitle: 'Ao aceitar este convite:',
      whatChanges: {
        sharedAccess: 'Vocês passam a compartilhar a mesma visão financeira,',
        flyAi: 'Você ganha acesso à IA da Fly no seu WhatsApp,',
        coupleDashboard: 'Você ganha acesso ao painel personalizado do casal,',
        launchVisibility: 'Seus lançamentos aparecem para {ownerName} e vice-versa,',
        ownerBilling: 'A assinatura continua somente sob responsabilidade do titular.',
      },
      termsPrefix: 'Clicando em "aceitar convite", você concorda com os',
      termsLinkLabel: 'Termos de Uso',
      termsSuffix: 'e criará o seu login.',
      invalidToken: 'Token de convite inválido.',
      errors: {
        acceptFailed: 'Não foi possível aceitar o convite da conta de casal.',
      },
  ...
  'en-US': {
    ...
    transactions: {
      ...
      invalidCsvFile: 'Invalid file. Please upload a .csv or .pdf file.',
      previewTable: {
        date: 'Date',
      ...
      removeFromPreview: 'Remove from import',
      previewDialog: {
        title: 'Transactions to import',
        aiApplied: 'AI applied',
        subtitle: 'Review, categorize or rename transactions before confirming.',
        noneFound: 'No transactions found',
        newCount: '{count} transactions',
        newCountSince: '{count} transactions since {date}',
        importing: 'Importing...',
        confirmImport: 'Confirm Import',
        tip: 'Tip: double click the description to edit. Use the category selector to adjust.',
        cardDetected: 'Card detected: {cardName}',
        cardNotDetected: 'Could not identify the card automatically.',
        selectCard: 'Select card',
        noCardsRegistered: 'No cards registered.',
        uncategorizedTitle: 'Unidentified expenses',
        uncategorizedSubtitle: 'Could not identify the category for the transactions below. How would you like to categorize them?',
        proceedAnyway: 'Proceed without categorizing',
        installmentBadge: 'Installment',
      },
      bulkRename: {
        title: 'Rename matching descriptions?',
        description:
          'There are {count} transactions for this same merchant. Rename all to "{value}"?',
        cancel: 'Cancel',
  ...
  'es-ES': {
    ...
    transactions: {
      ...
      invalidCsvFile: 'Archivo inválido. Sube un archivo .csv o .pdf.',
      previewTable: {
        date: 'Fecha',
      ...
      doubleClickToEdit: 'Doble clic para editar la descripción',
      suggestedCategoryBy: 'Categoría sugerida por: {keyword}',
      selectCategory: 'Seleccionar categoría',
      removeFromPreview: 'Quitar de la importación',
      previewDialog: {
        title: 'Transacciones a importar',
        aiApplied: 'IA aplicada',
        subtitle: 'Revisa, categoriza o renombra las transacciones antes de confirmar.',
        noneFound: 'No se encontró ninguna transacción',
        newCount: '{count} transacciones',
        newCountSince: '{count} transacciones desde {date}',
        importing: 'Importando...',
        confirmImport: 'Confirmar Importación',
        tip: 'Tip: doble clic en la descripción para editar. Usa el selector de categoría para ajustar.',
        cardDetected: 'Tarjeta detectada: {cardName}',
        cardNotDetected: 'No se pudo identificar la tarjeta automáticamente.',
        selectCard: 'Seleccionar tarjeta',
        noCardsRegistered: 'No hay tarjetas registradas.',
        uncategorizedTitle: 'Gastos no identificados',
        uncategorizedSubtitle: 'No pude identificar la categoría de los gastos a continuación. ¿Cómo deseas categorizarlos?',
        proceedAnyway: 'Continuar de todas formas',
        installmentBadge: 'A plazos',
      },
      bulkRename: {
        title: '¿Renombrar descripciones iguales?',
        description:
          'Hay {count} transacciones para ese mismo comercio. ¿Renombrar todas a "{value}"?',
        cancel: 'Cancelar',
        confirm: 'Aplicar a todas',
      },
      bulkCategory: {
        title: '¿Cambiar categoría en masa?',
        description:
          'Hay {count} transacciones con la descripción "{description}". ¿Aplicar la categoría seleccionada a todas?',
        cancel: 'Cancelar',
        confirm: 'Aplicar a todas',
      },
      onboarding: {
